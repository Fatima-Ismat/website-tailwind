                ...
                <div className="section-content max-w-6xl mx-auto flex flex-col md:flex-row items-center px-6 md:px-12 space-y-10 md:space-y-0 md:space-x-12">
                    ...
                    <div className="hero-details text-center md:text-left space-y-6 md:w-1/2">
                        ...
                        <div className="buttons flex justify-center md:justify-start">
                            <Link href="#" className="button order-now px-6 py-2 border-2 border-transparent text-primary bg-secondary rounded-full font-medium sm:text-sm hover:text-white hover:bg-transparent hover:border-white transition duration-300">
                              Order Now
                            </Link>

                            <Link href="#" className="button contact-us px-6 py-2 border-2 border-transparent bg-transparent border-white text-white rounded-full font-medium sm:text-sm hover:text-primary hover:bg-secondary hover:border-secondary transition duration-300">
                                Contact Us
                            </Link>
                        </div>
                    </div>
                    
                    <div className="hero-image-wrapper md:w-1/2 flex justify-center mb-6">
